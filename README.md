...
```bash
git clone [https://github.com/pavithra21635/InvoiceMate-Invoice-Generating-Web-Application.git](https://github.com/pavithra21635/InvoiceMate-Invoice-Generating-Web-Application.git)
